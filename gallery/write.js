...
(function () {
  ...
  var 서비스지역 = ["순천", "여수", "광양", "고흥", "하동", "남원", "광주", "진주", "통영"];
  ...
  function 블로그만들기(d) {
    ...
    var 지 = (d.지역 && !겹침) ? d.지역 + " " : "";
    var 지역명 = d.지역 || "전남 동부";
    var 다른지역 = 서비스지역.filter(function (r) { return r !== d.지역; }).join(" · ");
    var 서명 = 엮기([
      "─────────────",
      "큰길브리지 · 대표 김효민",
      "홈페이지 제작 · 홍보영상 · 쇼츠 · AI 강의",
      "순천 · 여수 · 광양 · 고흥 · 하동 · 남원 · 광주 · 진주 · 통영",
      "홈페이지 " + SITE,
    ...
    var 본문 = {
      web: function () {
        return 엮기([
          ...
          지역명 + "을 비롯해 " + 다른지역 + " 어디든 진행합니다. " + (d.업종 || "가게") + " 홈페이지를 고민 중이시라면 편하게 전화 주세요.", "",
          서명, "", 해시태그(d, false)
        ]);
      },
      video: function () {
        return 엮기([
          ...
          지역명 + " · " + 다른지역 + " 어디든 진행합니다. 홍보영상이 필요하시면 전화 주세요.", "",
          서명, "", 해시태그(d, false)
        ]);
      },
      event: function () {
        return 엮기([
          ...
          지역명 + " · " + 다른지역 + "에서 축제 · 공연 · 체육대회 · 기념식 준비 중이시라면 일정만 알려주세요.", "",
          서명, "", 해시태그(d, false)
        ]);
      },
      edu: function () {
        return 엮기([
          ...
          (d.고객말 ? "\n" + d.고객말 + "\n" : false),
          "",
          "AI 활용 1:1 강의는 2시간 10만원부터입니다. 업종과 수준에 맞춰 그날 진도를 조정하고, 상인회 · 협회 단체 출강도 나갑니다.",
          지역명 + " · " + 다른지역 + " 어디든 방문합니다.", "",
          서명, "", 해시태그(d, false)
        ]);
      }
  ...
  function HTML만들기(d, 제목) {
    ...
    return [
     ...
     .concat([
      ...
      '  <h2>' + (d.지역 || "전남 · 경남") + '에서 ' + 유형[d.유형].일 + '이 필요하시면</h2>',
      '  <p>순천 · 여수 · 광양 · 고흥 · 하동 · 남원 · 광주 · 진주 · 통영 어디든 진행합니다. 지금 하고 계신 일만 말씀해 주시면 필요한 것과 필요 없는 것을 솔직하게 알려드립니다.</p>',
      '',
      '  <div class="cta">',
      ...
      '  <p>순천 · 여수 · 광양 · 고흥 · 하동 · 남원 · 광주 · 진주 · 통영 홈페이지 제작 · 홍보영상 · 쇼츠 · AI 강의</p>',
