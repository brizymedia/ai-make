...
| `apps-script/funnel/큰길브리지-자동영업서버.gs` | 리드 대장 · 자동 메일 · 후속 메일 · 결제 승인 · 입금 확인 · 매일 현황 |
...
main 에 합쳐지면 바로 열립니다 (파일은 저장소 맨 위에 있고, 이 문서만 `docs-funnel/` 에 있습니다).
- 무료 자료: `https://www.ai-make.co.kr/free/` ← 인스타 · 스레드 · 유튜브 프로필 링크는 여기로
- 자동 견적: `https://www.ai-make.co.kr/go/`
- 결제: `https://www.ai-make.co.kr/pay/?c=계약ID` (계약서 서명 후 자동으로 열림)
- 전자책: `https://www.ai-make.co.kr/ebook/`
- SNS 카드 이미지: `https://www.ai-make.co.kr/sns/cards/p01/1.jpg` … (인스타 · 스레드가 여기서 이미지를 가져감)
...
2. `Code.gs` 내용을 지우고 **`apps-script/funnel/큰길브리지-자동영업서버.gs`** 를 통째로 붙여넣기 → 저장
...
GitHub → **brizymedia/ai-make** → **Settings → Secrets and variables → Actions**
...
| 변수 | `BRIDGE_LANDING` | (선택) 무료 자료 주소 — 기본 `https://www.ai-make.co.kr/free/` |
